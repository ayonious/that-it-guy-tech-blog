...
Just donwload and install from official website

## Useful commands

`cmd + shift + p` => for searching for commnds that are available with extensions
...
```bash
cmd + p           goto file
cmd + shift + f   seachr for words in whole project
