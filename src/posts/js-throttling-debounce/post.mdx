...
Imgine you put an event listener to scroll event but ccalling only once a second is enough. But during scroll you are getting this event like 100 times a minute. Use Here debounce and throttle to filter out these unwanted events.
