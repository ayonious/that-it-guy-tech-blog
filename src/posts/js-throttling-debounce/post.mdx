...
Imagine you put an event listener to scroll event but ccalling only once a second is enough. But during scroll you are getting this event like 100 times a minute. Use Here debounce and throttle to filter out these unwanted events.

I prefet to use the builtin function of Lodash to do this. You can also make this yourself.
...
Defintion: Call a function only if it has not been called in last 100 ms (time window).
...
// time of 100ms where user didnt press any keys
