...
There are following phases of Eventloop that happens again and again. Each phase has its own queue. At each phase that queue is finished and next phase started
...
2. https://medium.com/javascript-in-plain-english/node-js-event-loop-explained-d27647ec8d53
