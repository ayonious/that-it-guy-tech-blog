...
# Tripple equal operator (preferred)

This is exact operator for matching data. if they are of difference types they will never be equal and js dont tries to convert.
