...
if you have used var you don't nee to declare it before using it. If you declare it even at end it will be considered declared with undefined
...
There are some other weird behaviors but I don't want to get overloaded understanding all of these cases: Just read them here
